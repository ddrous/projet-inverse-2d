...
\usepackage[french]{babel} %% For automatically changing names of document elements to other languages
...
\thesistitle{Modelisation de l'equation du transfer radiatif et reconstruction de la densite par un reseau de neurones} % Your thesis title, ths is used in the title and abstract, print it elsewhere with \ttitle
...
\subject{Mathematiques Appliquees} % Your subject area, this is not currently used anywhere in the template, print it elsewhere with \subjectname
...
\group{\href{http://irma.math.unistra.fr/rubrique162.html}{equipe MOCO}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\large \textit{Stage realise dans le cadre du \degreename}\\[0.2cm] % University requirement text
\textit{du 15 juin 2020 au 15 aout 2020}\\[0.2cm]
\textit{au sein de l'\groupname}\\[0.2cm] % Research group
\textit{a l'\deptname}\\[2cm] % Department name

\large Annee academique 2020 - 2021
...
\qquad Je tiens à remercier dans un premier temps mes maîtres de stages de m’avoir permis d’effectuer un stage scientifique très enrichissant dans les meilleurs conditions possibles, compte tenu de la situation sanitaires liée au COVID-19. Je remercie aussi mes camarades de CSMI Guillaume \textsc{Steimer} et Léo \textsc{Bois} pour leurs conseils.
...
$\rho$ & densite du milieu & \si{\kg\per\meter\cubed} \\
$\sigma_a$ & opacite d'absorption & \si{\per\meter} \\
$\sigma_c$ & opacite de diffusion (de scattering) & \si{\per\meter} \\
%Symbol & Name & Unit \\

\addlinespace % Gap to separate the Roman symbols from the Greek

$c$ & vitesse de la lumiere & \si{\meter\per\second} \\
